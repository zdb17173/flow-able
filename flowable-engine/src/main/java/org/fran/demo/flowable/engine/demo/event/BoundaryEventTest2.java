...
/**
 * @author fran
 * @Description message边界事件demo
 * @Date 2022/5/5 18:44
 */
public class BoundaryEventTest2 {
    ...
    public static void main(String[] args) {
        ...
        //流程  start --> user --> 结束
        //                user边界事件msg-01 -->自动执行--> 结束

        RepositoryService repositoryService = processEngine.getRepositoryService();
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("event/event-test-boundary-2.bpmn20.xml")
                .deploy();
...
//            taskService.complete(task.getId());
        ...
        */
        //sid-4D4A3667-CDC2-42AF-9F22-9C10F4D1B941

        //找到边界消息的executionId， 向他发送消息
        List<Execution> executions = runtimeService.createExecutionQuery()
//                .processInstanceId(instance.getId()) // 只查询当前流程实例 或 查询所有实例
