...
/**
 * @author fran
 * @Description 测试信号发送，信号会发送到所有deploy的流程中
 * @Date 2022/5/5 15:23
 */
public class EventSignalTest1 {
    public static void main(String[] args) {
        ...
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("event/event-test-start-signal-1.bpmn20.xml")
                .addClasspathResource("event/event-test-start-signal-2.bpmn20.xml")
                .deploy();
